...
Item {
    ...
    Text {
        ...
        text: Qt.formatDate(new Date(), "<b>ddd</b> d MMM")
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            var rot = (wallClock.getHours() - 3 + wallClock.getMinutes()/60) / 12
            ctx.reset()
            ctx.lineWidth = 4
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath()
            ctx.moveTo(parent.width/2, parent.height/2)
            ctx.lineTo(parent.width/2+Math.cos((wallClock.getMinutes() - 15)/60 * 2 * Math.PI)*width*0.32,
                       parent.height/2+Math.sin((wallClock.getMinutes() - 15)/60 * 2 * Math.PI)*width*0.32)
            ctx.stroke()
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.beginPath()
            ctx.moveTo(parent.width/2, parent.height/2)
            ctx.lineTo(parent.width/2+Math.cos((wallClock.getSeconds() - 15)/60 * 2 * Math.PI)*width*0.335,
                       parent.height/2+Math.sin((wallClock.getSeconds() - 15)/60 * 2 * Math.PI)*width*0.335)
            ctx.stroke()
        }
    }
