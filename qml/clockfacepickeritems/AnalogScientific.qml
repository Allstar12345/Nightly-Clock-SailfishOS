...
signal timeChanged
   ...
   Timer {
       ...
       running: true;
       repeat: true;
       onTriggered: wallClock.timeChanged()
   }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.moveTo(parent.width/2+Math.cos(((hour-3.02 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.31,
                       parent.height/2+Math.sin(((hour-3.02 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.31)
            ctx.lineTo(parent.width/2+Math.cos(((hour-3.22 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.2,
                       parent.height/2+Math.sin(((hour-3.22 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.2)
            ctx.lineTo(parent.width/2+Math.cos(((hour-7.00 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.01,
                       parent.height/2+Math.sin(((hour-7.00 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.01)
            ctx.lineTo(parent.width/2+Math.cos(((hour-11 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.01,
                       parent.height/2+Math.sin(((hour-11 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.01)
            ctx.lineTo(parent.width/2+Math.cos(((hour-2.78 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.2,
                       parent.height/2+Math.sin(((hour-2.78 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.2)
            ctx.lineTo(parent.width/2+Math.cos(((hour-2.98 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.31,
                       parent.height/2+Math.sin(((hour-2.98 + wallClock.getMinutes()/60) / 12) * 2 * Math.PI)*width*0.31)
            ctx.fill()
            ctx.closePath()
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            var text;
            text = wallClock.toLocaleString(Qt.locale(), "ddd").slice(0, 2).toUpperCase()
    ...
    Canvas {
        ...
        onPaint: {
            ...
            var text;
            text = wallClock.toLocaleString(Qt.locale(), "ap").slice(0, 2).toUpperCase()
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.fillText(wallClock.toLocaleString(Qt.locale(), "dd"),
                         width/2,
                         height*0.315);
        }
    }
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.fillText(wallClock.toLocaleString(Qt.locale(), "MMMM").toUpperCase(),
                         width/2,
                         height*0.372);
        }
    }
